...
export const TermsOfService = () => {
  return (
    <div className={classes.root}>
      ...
      <p>
        <strong>Last updated</strong> <strong>March 05, 2025</strong>
      </p>
      <h2 id="agreement-to-our-legal-terms">AGREEMENT TO OUR LEGAL TERMS</h2>
      <p>
        We are Fern Labour (&#39;<strong>Company</strong>&#39;, &#39;<strong>we</strong>&#39;, &#39;
        <strong>us</strong>&#39;, or &#39;<strong>our</strong>&#39;) , a company registered in the
        United Kingdom.
      </p>
      <p>
        We operate the website <a href="https://fernlabour.com">https://fernlabour.com</a> (the
      ...
      <p>A labour and contraction tracking application with live updates for friends and family.</p>
      <p>
        You can contact us by email at{' '}
        <a href="mailto:&#x73;&#x75;&#x70;&#112;&#111;&#114;&#116;&#x40;&#x66;&#101;&#x72;&#x6e;&#x6c;&#x61;&#98;&#x6f;&#117;&#x72;&#x2e;&#x63;&#x6f;&#109;">
      ...
      <p>
        ...
        personally or on behalf of an entity ( &#39;<strong>you</strong>&#39;), and Fern Labour,
      ...
      <p>
        <a href="#license">8. CONTRIBUTION LICENCE</a>
      </p>
      <p>
      ...
      <p>
        <a href="#electronic">21. ELECTRONIC COMMUNICATIONS, TRANSACTIONS, AND SIGNATURES</a>
      </p>
      <p>
        <a href="#sms">22. SMS TEXT MESSAGING</a>
      </p>
      <p>
      ...
      <h3 id="your-submissions-and-contributions">Your submissions and contributions</h3>
      <p>
      ...
      <p>
        ...
        of, or incorporate into other works, your Contributions, and to sublicence the licences
      ...
      <ul>
        ...
        <li>Unreasonable use of the announcements feature.</li>
      </ul>
      ...
      <ul>
        ...
        <li>
          ...
          releases, and permissions to use and to authorise us, the Services, and other users of the
      ...
      <p>
        ...
        works of, or incorporate into other works, such Contributions, and grant and authorise
        sublicences of the foregoing. The use and distribution may occur in any media formats and
      ...
      <p>
        ...
        into these Legal Terms. Please be advised the Services are hosted in the United Kingdom . If
        ...
        the United Kingdom , then through your continued use of the Services, you are transferring
        your data to the United Kingdom , and you expressly consent to have your data transferred to
      ...
      <p>
        These Legal Terms are governed by and interpreted following the laws of the United Kingdom ,
        ...
        of the law in your country to residence. Fern Labour and yourself both agree to submit to
        the non-exclusive jurisdiction of the courts of Wakefield, which means that you may make a
      ...
      <p>Change your notification preferences in the app to remove SMS text messages.</p>
