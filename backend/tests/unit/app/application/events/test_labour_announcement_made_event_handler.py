...
async def test_labour_update_posted_event_no_subscribers(
    ...
    assert (
        labour_update_posted_event_handler._notification_service._email_notification_gateway.sent_notifications
        == []
    )
    assert (
...
async def test_labour_update_posted_event_non_existent_subscriber(
    ...
    await add_subscriber_to_birthing_person(
        birthing_person_service=labour_update_posted_event_handler._birthing_person_service,
        birthing_person_id=BIRTHING_PERSON,
        subscriber_id="TEST",
    )
...
async def test_labour_update_posted_event_has_subscriber_no_contact_methods(
    ...
    await labour_update_posted_event_handler._subscriber_service.register(
