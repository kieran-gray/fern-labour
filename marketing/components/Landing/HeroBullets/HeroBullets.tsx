    ...
    <Container size="lg" className={classes.container} id="#home">
      <div className={classes.inner}>
        <div className={classes.content}>
          ...
          <Text mt="md">
            Track every contraction, share real-time updates, and keep loved ones connected - all in
            one place.
          </Text>
          ...
          <List mt={30} spacing="sm" size="sm">
            ...
            >
              <b>Invite friends and family</b> – Share invites to follow your labour by link, email,
              or QR code.
            </List.Item>
            <List.Item
              icon={
            ...
            >
              <b>Automatic notifications</b> – Friends and Family are notified when you start labour
              and you can keep them updated with announcements
            </List.Item>
          </List>
