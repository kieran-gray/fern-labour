import { Accordion, Container, Title, ThemeIcon } from '@mantine/core';
        ...
        >
          <Accordion.Item className={classes.item} value="hospital">
            ...
            <Accordion.Panel className={classes.panel}>
              ...
              your contractions follow a 3-1-1 pattern (contractions every 3 minutes, lasting 
              1 minute, for 1 hour).<br></br>For those who have given birth before, you'll be notified at 
              a 5-1-1 pattern (contractions every 5 minutes, lasting 1 minute, for 1 hour).<br></br>
          ...
          <Accordion.Item className={classes.item} value="remove-subs">
            ...
            <Accordion.Panel className={classes.panel}>
              ...
              immediately stop receiving notifications.
            </Accordion.Panel>
          </Accordion.Item>
          ...
          <Accordion.Item className={classes.item} value="data-storage">
            ...
            encryption for all data transmission, and your identifying information is encrypted when 
            stored.<br></br>You can request to delete your data at any time through the app.
            </Accordion.Panel>
          </Accordion.Item>
          ...
          <Accordion.Item className={classes.item} value="partner-updates">
            ...
            using their own device - just share your unique access code with them.<br></br>You maintain full 
