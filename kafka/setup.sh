...
kafka-topics.sh --bootstrap-server ${KAFKA_BOOTSTRAP_SERVERS} --create --if-not-exists --topic ${KAFKA_TOPIC_PREFIX}.labour.announcement-made --replication-factor 1 --partitions 1
