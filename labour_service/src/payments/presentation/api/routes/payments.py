...
from src.payments.presentation.api.schemas.requests.payments import CreateCheckoutRequest
from src.payments.presentation.api.schemas.responses.payments import CheckoutResponse
