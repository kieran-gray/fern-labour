...
oauth2_scheme: OAuth2AuthorizationCodeBearer = OAuth2AuthorizationCodeBearer(
    authorizationUrl="http://localhost:8080/realms/contraction_tracker/protocol/openid-connect/auth",
    tokenUrl="http://localhost:8080/realms/contraction_tracker/protocol/openid-connect/token",
    refreshUrl="http://localhost:8080/realms/contraction_tracker/protocol/openid-connect/token",
)
