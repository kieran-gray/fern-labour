...
import classes from './ContractionList.module.css';

export default function ContractionList({contractions, contractionGaps}: {contractions: ContractionDTO[], contractionGaps: Record<string, string | null>}) {
