      ...
      <Tabs.List justify="space-between" style={{ width: '100%' }}>
        ...
        {statistics.total && (
          <Tabs.Panel value="all">
            <LabourStatisticsTabPanel data={statistics.total} />
          </Tabs.Panel>
        )}
        <Tabs.Panel value="60mins">
          {(statistics.last_60_mins && (
            <LabourStatisticsTabPanel data={statistics.last_60_mins} />
        ...
        <Tabs.Panel value="30mins">
          {(statistics.last_30_mins && (
            <LabourStatisticsTabPanel data={statistics.last_30_mins} />
