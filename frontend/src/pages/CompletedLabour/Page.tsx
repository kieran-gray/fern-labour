                ...
                <div className={baseClasses.flexRow} style={{ flexWrap: 'nowrap' }}>
                  <div className={baseClasses.flexColumn}>
                    <Text c="var(--mantine-color-gray-7)" mt="md" size="md">
                      ...
                      of you. Take a deep breath, soak in this beautiful moment, and know that you
                      are amazing.
                    </Text>
                    ...
                    <Text c="var(--mantine-color-gray-7)" mt="sm" size="md">
                      ...
                      we'd love to know what you liked or what you would like to see done
                      differently through the contact form below.
                    </Text>
                    <Button
                      size="md"
                      mt={20}
