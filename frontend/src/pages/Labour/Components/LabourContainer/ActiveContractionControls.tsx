...
import EndContractionButton from '../Buttons/EndContraction.tsx';
...
export function ActiveContractionControls({stopwatchRef, activeContraction}: {stopwatchRef: RefObject<StopwatchHandle>, activeContraction: ContractionDTO}) {
