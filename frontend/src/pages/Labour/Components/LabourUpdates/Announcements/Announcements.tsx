...
import { ScrollArea, TextInput, Title, Text, Button } from '@mantine/core';
...
export function Announcements({ announcementHistory, setActiveTab}: { announcementHistory: AnnouncementDTO[], setActiveTab: Function }) {
